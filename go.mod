...
require (
	...
	github.com/annetutil/gnetcli v1.3.15
...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/extension/encoding/otlpencodingextension v0.144.0 // indirect
