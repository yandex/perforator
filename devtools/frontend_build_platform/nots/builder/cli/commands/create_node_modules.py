...
def create_node_modules_func(args: CreateNodeModulesOptions):
    context = create_node_modules(args)
    # This command is itself the complete materialization action; it has no build phase.
    bundle_workspace_node_modules(args, context)
    return []
