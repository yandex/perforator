...
// EnterExprPipe is called when production exprPipe is entered.
func (s *BaseSolomonParserListener) EnterExprPipe(ctx *ExprPipeContext) {}

// ExitExprPipe is called when production exprPipe is exited.
func (s *BaseSolomonParserListener) ExitExprPipe(ctx *ExprPipeContext) {}

// EnterExprTernary is called when production exprTernary is entered.
func (s *BaseSolomonParserListener) EnterExprTernary(ctx *ExprTernaryContext) {}

// ExitExprTernary is called when production exprTernary is exited.
func (s *BaseSolomonParserListener) ExitExprTernary(ctx *ExprTernaryContext) {}
...
// EnterAtomCallWithBy is called when production AtomCallWithBy is entered.
func (s *BaseSolomonParserListener) EnterAtomCallWithBy(ctx *AtomCallWithByContext) {}

// ExitAtomCallWithBy is called when production AtomCallWithBy is exited.
func (s *BaseSolomonParserListener) ExitAtomCallWithBy(ctx *AtomCallWithByContext) {}
