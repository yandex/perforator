...
type SolomonParserListener interface {
	...
	// EnterExprPipe is called when entering the exprPipe production.
	EnterExprPipe(c *ExprPipeContext)
	...
	// EnterAtomCallWithBy is called when entering the AtomCallWithBy production.
	EnterAtomCallWithBy(c *AtomCallWithByContext)
	...
	// ExitExprPipe is called when exiting the exprPipe production.
	ExitExprPipe(c *ExprPipeContext)
	...
	// ExitAtomCallWithBy is called when exiting the AtomCallWithBy production.
	ExitAtomCallWithBy(c *AtomCallWithByContext)
