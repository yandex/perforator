...
enum metric : u32 {
    ...
    METRIC_ERROR_STAGE_PACK_SAMPLE_LANG_COUNT, // Failed to write language section to `packed_sample`
    ...
    METRIC_PYTHON_READ_INSTR_PTR_ERROR_COUNT,
    METRIC_PYTHON_READ_CO_LINETABLE_ERROR_COUNT,
