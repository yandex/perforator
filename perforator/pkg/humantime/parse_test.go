...
func TestHumanTimeParse(t *testing.T) {
	for _, test := range []struct {
		...
		{
			"relative in past with spaces 1",
			"now         - 5h2m1ns",
			time.Date(1337, time.January, 24, 5, 13, 7, 1, time.UTC),
			ptr.T(time.Date(1337, time.January, 24, 10, 15, 7, 2, time.UTC)),
			"",
		...
		{
			"relative in past with spaces 2",
			"now         -5h2m1ns",
			time.Date(1337, time.January, 24, 5, 13, 7, 1, time.UTC),
			ptr.T(time.Date(1337, time.January, 24, 10, 15, 7, 2, time.UTC)),
			"",
		},
		{
			"relative in future",
			"now+5h2m1ns",
			time.Date(1337, time.January, 24, 15, 17, 7, 3, time.UTC),
			ptr.T(time.Date(1337, time.January, 24, 10, 15, 7, 2, time.UTC)),
			"",
		},
		{
			"relative in future with spaces 1",
			"now         + 5h2m1ns",
			time.Date(1337, time.January, 24, 15, 17, 7, 3, time.UTC),
			ptr.T(time.Date(1337, time.January, 24, 10, 15, 7, 2, time.UTC)),
			"",
		...
		{
			"relative in future with spaces 2",
			"now         +5h2m1ns",
			time.Date(1337, time.January, 24, 15, 17, 7, 3, time.UTC),
			ptr.T(time.Date(1337, time.January, 24, 10, 15, 7, 2, time.UTC)),
			"",
